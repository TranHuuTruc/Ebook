...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="admin/Home.jsp">Home <span class="sr-only">(current)</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#"><i class="fa-solid fa-book-open-reader"></i> Recent Book</a></li>
			
			<li class="nav-item"><a class="nav-link" href="#"><i class="fa-solid fa-book-open-reader"></i>  New Book</a></li>
			<li class="nav-item"><a class="nav-link" href="#"><i class="fa-solid fa-book"></i>  Old Book</a></li>
